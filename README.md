# Temu Number Checker API — official examples | CheckNumber

This repository documents the CheckNumber Temu Number Checker API integration contract using facts from the expansion manifest.

- Product page: https://checknumber.ai/products/temu
...
```bash
curl -X POST "https://api.checknumber.ai/v1/tasks" -H "X-API-Key: ${CHECKNUMBER_API_KEY}" -F "file=@examples/numbers.txt" -F "task_type=temu"
...
| --- | --- | --- | --- | --- | --- |
| `temu` | Number Checker | phone | 1000–100000 rows | `number, activated` | [docs](https://docs.checknumber.ai/temu-checker) |
...
- `temu`: https://docs.checknumber.ai/temu-checker
